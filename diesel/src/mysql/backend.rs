...
/// Each variant represents one of the forms documented in [the mysql docs][mysql-docs]
/// [mysql-docs](https://dev.mysql.com/doc/refman/5.7/en/c-api-prepared-statement-type-codes.html)
///
